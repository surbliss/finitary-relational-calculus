...
- `Dict` (the main subproject) takes a very different: It models relations as _symmetric differences_ using a wild-card operator, to make complements easier to produce.
